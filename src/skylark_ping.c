...
char *url = "https://broker.skylark2.swiftnav.com";
char *device = "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa";
char *lat = "37.771020087057224";
char *lon = "-122.40315156104454";
char *height = "-5.545258791564813";
bool uploadf = false;
...
int parse_options(int argc, char *argv[])
{
  ...
  struct option long_opts[] = {
    ...
    {"upload",   no_argument,       NULL, OPT_UPLOAD},
    {"download", no_argument,       NULL, OPT_DOWNLOAD},
    {NULL,       0,                 NULL, 0},
  };
...
size_t upload(char *buf, size_t size, size_t n, void *data)
{
  ...
  if (now - last > 10) {
    ...
    uint16_t crc = checksum((uint8_t *)&pos_llh, sizeof(pos_llh));
...
int download_request(void)
{
  ...
  char device_buf[256];
  snprintf(device_buf, sizeof(device_buf), "Device-Uid: %s", device);
